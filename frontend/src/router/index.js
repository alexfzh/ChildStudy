...
const routes = [
  ...
  { path: "/timeline", name: "timeline", component: () => import("@/views/Timeline.vue"), meta: { title: "成长时间轴", role: "parent" } },
  ...
  { path: "/growth", name: "growth", component: () => import("@/views/Growth.vue"), meta: { title: "生长发育", role: "parent" } },
