...
const routes = [
  ...
  { path: "/", redirect: "/dashboard" },
  {
    ...
    meta: { title: "家长看板", role: "parent" },
  },
  {
    path: "/children",
    name: "children",
    component: () => import("@/views/Children.vue"),
    meta: { title: "孩子档案", role: "parent" },
  },
  {
    path: "/exams",
    name: "exams",
    component: () => import("@/views/Exams.vue"),
    meta: { title: "考试管理", role: "parent" },
  },
  {
    path: "/exam-analysis",
    name: "exam-analysis",
    component: () => import("@/views/ExamAnalysis.vue"),
    meta: { title: "考试分析", role: "parent" },
  },
  {
    path: "/homeworks",
    name: "homeworks",
    component: () => import("@/views/Homework.vue"),
    meta: { title: "作业追踪", role: "parent" },
  },
  {
    path: "/ai-reports",
    name: "ai-reports",
    component: () => import("@/views/AIReports.vue"),
    meta: { title: "AI 报告管理", role: "parent" },
  },
  {
    path: "/timeline",
    name: "timeline",
    component: () => import("@/views/Timeline.vue"),
    meta: { title: "成长时间轴", role: ["parent", "child"] },
  },
  {
    path: "/settings",
    name: "settings",
    component: () => import("@/views/Settings.vue"),
    meta: { title: "系统设置", role: ["parent", "child"] },
  },
  {
    path: "/knowledge-points",
    name: "knowledge-points",
    component: () => import("@/views/KnowledgePoints.vue"),
    meta: { title: "知识点标签库", role: "parent" },
  },
  {
  ...
  },
  {
    ...
    meta: { title: "生长发育", role: ["parent", "child"] },
  },
  {
    path: "/social-emotional",
    name: "social-emotional",
    component: () => import("@/views/SocialEmotional.vue"),
    meta: { title: "社交情感", role: "parent" },
  },
  {
    path: "/interests",
    name: "interests",
    component: () => import("@/views/Interests.vue"),
    meta: { title: "兴趣特长", role: "parent" },
  },
  ...
  },
  {
    path: "/project-works",
    name: "project-works",
    component: () => import("@/views/ProjectWorks.vue"),
    meta: { title: "单元 Big Task" },
  },
